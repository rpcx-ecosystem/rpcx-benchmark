...
func (*BenchmarkMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_micro_benchmark_c60d4e134249b2d1, []int{0}
}
...
func init() {
	proto.RegisterFile("micro_benchmark.proto", fileDescriptor_micro_benchmark_c60d4e134249b2d1)
}

var fileDescriptor_micro_benchmark_c60d4e134249b2d1 = []byte{
